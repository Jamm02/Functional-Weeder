defmodule ToyRobot do
  ...
  def correct_X(%ToyRobot.Position{x: x, y: y, facing: facing} = _robot, goal_x, goal_y, channel) do
    %ToyRobot.Position{x: x, y: y, facing: facing} = _robot
...
def objInY_north(%ToyRobot.Position{x: x, y: y, facing: facing} = _robot, goal_x, goal_y, channel, repeat) do
  %ToyRobot.Position{x: x, y: y, facing: facing} = _robot
  ...
  if (x == 1) or (repeat == 1)  do  #turn and right and face north
    ...
    if(is_obs) do
      ...
      if(is_obs) do
        objInX_east(%ToyRobot.Position{x: x, y: y, facing: facing} = _robot, goal_x, goal_y, channel, repeat = 0)
      else
        robot = move(robot)
        %ToyRobot.Position{x: x, y: y, facing: facing} = _robot
        # ToyRobot.PhoenixSocketClient.send_robot_status(channel, robot)
    ...
    if(is_obs) do
      ...
      if(is_obs) do
        objInX_west(%ToyRobot.Position{x: x, y: y, facing: facing} = _robot, goal_x, goal_y, channel, repeat = 0)
      else
        robot = move(robot)
        %ToyRobot.Position{x: x, y: y, facing: facing} = _robot
        # ToyRobot.PhoenixSocketClient.send_robot_status(channel, robot)
...
def objInY_south(%ToyRobot.Position{x: x, y: y, facing: facing} = _robot, goal_x, goal_y, channel, repeat) do
...
def objInX_west(%ToyRobot.Position{x: x, y: y, facing: facing} = _robot, goal_x, goal_y, channel, repeat) do
  ...
  if (y == :a) or (repeat == 1) do  #turn, move left and face east
    ...
    if(is_obs) do
      ...
      if(is_obs) do
        objInY_north(%ToyRobot.Position{x: x, y: y, facing: facing} = _robot, goal_x, goal_y, channel, repeat = 0)
      else
        robot = move(robot)
        %ToyRobot.Position{x: x, y: y, facing: facing} = _robot
        # ToyRobot.PhoenixSocketClient.send_robot_status(channel, robot)
    ...
    if(is_obs) do
      ...
      if(is_obs) do
        objInY_south(%ToyRobot.Position{x: x, y: y, facing: facing} = _robot, goal_x, goal_y, channel, repeat = 0)
      else
        robot = move(robot)
        %ToyRobot.Position{x: x, y: y, facing: facing} = _robot
        # ToyRobot.PhoenixSocketClient.send_robot_status(channel, robot)
...
def objInX_east(%ToyRobot.Position{x: x, y: y, facing: facing} = _robot, goal_x, goal_y, channel, repeat) do
    ...
    if (y == goal_y) and (x == goal_x) do
      ...
      if y < goal_y do
        ...
        if (facing != :north) do
          ...
          if(ToyRobot.PhoenixSocketClient.send_robot_status(channel, robot)) do
